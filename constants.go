...
const bv string = "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36 Edg/112.0.1722.46"
...
[{
	...
	"value": [{
		...
		"value": "922170bf611d82459fa4eaf0da8d25dc"
	}, {
		"key": "webgl_renderer",
		"value": "WebKit WebGL"
	}, {
		...
		"value": "16,64,32768,4096,32768,32,32768,31,16,32,4096"
	}, {
		...
		"value": "ANGLE (NVIDIA, Vulkan 1.3.242 (NVIDIA NVIDIA GeForce RTX 3060 Ti (0x00002486)), NVIDIA)"
	}, {
		...
		"value": "f1ec8be82a2df9ac08b1fe5db5acba02"
	}, {
	...
	"key": "ife_hash",
	"value": "411c34615014b9640db1d4c3f65dbee5"
}, {
	"key": "cs",
	"value": 1
}, {
	"key": "jsbd",
	"value": "{\"HL\":3,\"NCE\":true,\"DT\":\"\",\"NWD\":\"false\",\"DOTO\":1,\"DMTO\":1}"
}]
`

var fe []map[string]interface{} = []map[string]interface{}{
	{"DNT": "1"},
	{"L": "zh-CN"},
	{"D": 24},
	{"PR": 1},
